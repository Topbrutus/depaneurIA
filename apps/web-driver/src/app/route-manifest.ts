export const driverRoutes = [
  ...
  { path: '/deliveries/available', name: 'available-deliveries', label: 'Livraisons Disponibles', status: 'v1' },
  ...
  { path: '/delivery/:id/contact', name: 'contact-customer', label: 'Contact Client', status: 'v1' },
